...
def handle_coordinates():
    ...
    path_process = find_direction_and_adjust_angle('팀원지도최종본_출발지만.png')
    print("현재 작업 디렉터리:", os.getcwd())
    find_and_draw_path('팀원지도최종본_출발지만.png', (76,193), (x,y))
    print("현재 작업 디렉터리:", os.getcwd())
...
def find_direction_and_adjust_angle(image_path):
    ...
    for contour in contours:
        if cv2.contourArea(contour) < 100:  # 너무 작은 객체는 무시
            continue
